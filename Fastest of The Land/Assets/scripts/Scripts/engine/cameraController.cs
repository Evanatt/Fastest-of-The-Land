...
public class cameraController : MonoBehaviour
{
    ...
    void Start(){
        ...
        cameraPos[1] = new Vector2(16.5f,2.8f);
    ...
    public void updateCam(){
        ...
        if(locationIndicator != cameraPos.Length-1){
            ...
            bandEffect = (controllerRef.motorTorque < 400) ? 300 - controllerRef.motorTorque / 400 : 200; 
            ...
            transform.localPosition += transform.forward * controllerRef.motorTorque / bandEffect ;

            bias = max - controllerRef.motorTorque / 400  ;
